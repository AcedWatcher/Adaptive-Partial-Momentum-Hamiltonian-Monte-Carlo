...
def generate_samples_apmhmc_z0(params, z0, n=10):
    ...
    for j in range(L):
        ...
        r = np.ones((1000, 2)) * 0.5 + 0.5 * (0.6 - r_acp)
        acp += accepted
