...
def demo(dataset, device="GPU", dtype=tf.float32):
    ...
    model_path="HMC-VI-mnist/model/mnist_/"
    ...
    with tf.Session() as sess:
        saver.restore(sess, model_path+"vae_dcnn_relu-hei-mnist-alpha0e+00-zd32-hd500-mbs128-mbn95000-h30-l5-reg1e-06-dybin-lr2e-04.ckpt-80000")
...
if __name__ == '__main__':
    ...
    np.savetxt('mnist_.csv',saved.reshape(10000),delimiter=',')
