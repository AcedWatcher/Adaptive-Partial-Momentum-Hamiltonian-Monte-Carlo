...
from core.ham import pmmc_leapfrog,leapfrog
import numpy as np
...
class HamInfNetHEI:
    ...
    def __build_LF_graph_hmc(self, pot_fun, state_init, momemtum, num_layers=None, back_prop=False):
        ...
        def _loopbody(layer_index, state, momemtum2):
            state_new, momemtum_new = pmmc_leapfrog(x=state,
                                         r = momemtum2,
                                         pot_fun=pot_fun,
                                         eps=self.lfstep_size[layer_index],
                                         r_var=1.0,
    ...
    def build_elbo_graph(self, pot_fun, state_init_gen, sample_batch_size, input_data_batch_size, training=False):
        ...
        势函数:param pot_fun: the potential function takes a batch of samples as input and outputs batch of potential values
