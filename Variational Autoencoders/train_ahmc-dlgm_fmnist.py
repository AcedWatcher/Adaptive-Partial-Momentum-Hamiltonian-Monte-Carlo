...
config.gpu_options.per_process_gpu_memory_fraction = 0.1  # 0.6 sometimes works better for folks
...
def training_setting(z_dim):
    setting = {'mb_size': 128,#128
               'alpha': 0.0,
               'z_dim': z_dim,
               'h_dim': 500,#500
               'X_mnist_dim': 28 ** 2,
               'momentum_train_batch_size': 1,
               'z_train_sample_batch_size': 30, #30
               'num_layers': 5,
               'num_lfsteps': 5,
               'momentum_std': 1.0,
               'generator': 'dcnn_relu',
...
if __name__ == '__main__':
    ...
    train(setting=training_setting(32), dataset=fmnist, save_model=True, device="gpu") # 32
