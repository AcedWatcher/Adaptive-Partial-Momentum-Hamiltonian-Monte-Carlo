...
from binarise_fashion_mnist_test import create_prebinarised_test_data
...
def demo(model_path, dataset=None, device="GPU", dtype=tf.float32):
    mb_demo_size = 36
    demo_size = (6, 6)
    setting = load_setting(model_path)
